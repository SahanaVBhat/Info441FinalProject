  ...
  render() {
      return ( 
          ...
          <div className="card-buttons">
            <button type="button" class="btn btn-primary" id="editEval" onClick={this.handleEdit}>Edit</button>
            <button type="button" class="btn btn-primary" id="deleteEval" onClick={this.handleRemove}>Remove</button>
          </div>
        </div>
      )
  }
